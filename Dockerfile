# Multi-Agent System: Production Docker Image
# Version: 1.0.0
...
# - Run CLI: docker run mas:1.0.0 mas --help
# - Run tests: docker run mas:1.0.0 pytest -v
# - Run REPL: docker run -it mas:1.0.0 python
